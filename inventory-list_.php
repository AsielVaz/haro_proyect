        ...
        <div class="col-lg-9">
          ...
          <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center">
              <?php
              if(!isset($_GET['marca'])){
                for ($i = 0; $i < ($adminAutos->cuentaAutos() / 6); $i++) {
                  if ($i == ($pagina - 1)) {
                    echo '<li class="page-item active"><a class="page-link" href="inventory-list.php?pagina=' . ($i + 1) . '">' . ($i + 1) . '</a></li>';
                  } else {
                    echo '<li class="page-item"><a class="page-link" href="inventory-list.php?pagina=' . ($i + 1) . '">' . ($i + 1) . '</a></li>';
                  }
                }
              }
