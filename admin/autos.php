    ...
    <div class="wrapper">
        ...
        <main class="main--container">
            ...
            <section class="main--content">
                ...
                <div class="panel">
                    <!-- Records List Start -->
                    <div class="records--list" data-title="Lista de autos">
                        <table id="recordsListView">
                            ...
                            <tbody>
                                ...
                                foreach ($autos as $auto) {
                                    echo "<tr>";
                                    echo "<td>" . $auto->id . "</td>";
                                    echo "<td><img src='" . $auto->imagen . "' alt=''></td>";
                                    ...
                                    echo "<td><div class='dropleft'><a href='' class='btn-link' data-toggle='dropdown'><i class='fa fa-ellipsis-v'></i></a><div class='dropdown-menu'><a href='autos_mod.php?id=" . $auto->id . "' class='dropdown-item'>Editar</a><a onclick='eliminar(" . $auto->id . ")' class='dropdown-item'>Eliminar</a></div></div></td>";
                                    echo "</tr>";
                                }
