...
function procesarAlta()
{
	...
	$admin->agregarAuto($cilindrage, $descripcion, $marca, $modelo, $transmicion, $anio, $precio, $nacionalidad, $duenio, $estatus, $kilometrage, $combustible, $interiores, $color, $cuerpo, $poder, $asientos, $kilometragePermitido, $consig);
...
function notificarAuto($modelo, $marca, $auto)
{
  ...
  <div style="text-align: center;">Gracias por usar el servicio de car Hunter de Seminuevos Haro.</div>';
	...
	foreach ($suscriptores as $suscriptor) {
      ...
      <img src="https://seminuevosharo.mx/img-mail/logo.png" target="_blank" class="img-fluid" style="text-align: var(--mdb-body-text-align); font-family: var(--mdb-font-roboto); font-size: var(--mdb-body-font-size); font-weight: var(--mdb-body-font-weight); background-color: rgba(255,255,255,var(--mdb-bg-opacity));">
      <br>
      </div>
      <div style="text-align: center;"><br></div>
      ...
      <p>Si deseas darse de baja de nuestro boletín, entra a este enlace <a href="https://seminuevosharo.mx/suscripciones.php?suscriptor=' . $suscriptor->id . '">Desuscribirse</a>.</p>
...
function procesarModificacion()
{
	...
	$admin = new AdministradorAutos();
	$admin->actualizarAuto($id, $cilindrage, $descripcion, $marca, $modelo, $transmicion, $anio, $precio, $nacionalidad, $duenio, $estatus, $kilometrage, $combustible, $interiores, $color, $cuerpo, $poder, $asientos, $consig);
	echo "1";
}
