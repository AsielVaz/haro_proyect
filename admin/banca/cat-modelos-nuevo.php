...
<body class="layout-boxed enable-secondaryNav">
                        ...
                        <div id="flLoginForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form class="forms-sample" id="formularioModelos">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nombre</label>
                                            <input type="text" class="form-control" name="modelo" id="exampleInputUsername1" placeholder="Modelo *" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Marca</label>
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary me-2">Nuevo Modelo</button>
    ...
    <script>
            var formularioMod = document.getElementById("formularioModelos");

            formularioMod.addEventListener("submit", function(e) {
                e.preventDefault();
                var datosDeInicioMod = new FormData(formularioMod);
                datosDeInicioMod.append("accion", "modelo");

                fetch("../api/apiEditor.php", {
                        method: "POST",
                        body: datosDeInicioMod,
                    })
                    ...
                    .then((data) => {
                        ...
                        if (data == "1") {
                            ...
                            window.location.href = "cat-modelos.php";
                        } else {
                            console.log("Error");
                        }
                    });
