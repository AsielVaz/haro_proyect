...
<body class="layout-boxed enable-secondaryNav">
                                ...
                                <div class="d-flex breadcrumb-content">
                                    <div class="page-header">
                                        ...
                                        <div class="page-title">
                                            <h3>Panel de creación de marcas</h3>
                                        </div>
                        ...
                        <div id="flLoginForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form class="forms-sample" id="formularioMarca">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Nombre</label>
                                            <input type="text" class="form-control" id="exampleInputUsername1" name="marca" placeholder="Marca *" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Imagen (Dimencion recomendada 240 x 200, 480
                                                x 400, 960 x 800)</label>
                                            <input type="file" name="archivo" class="form-control" id="preview" required>
                                        </div>
                                        <div id="img-preview"></div>
                                        <div class="mb-3"></div>
                                        <button type="submit" class="btn btn-primary me-2">Nueva Marca</button>
                                        <button class="btn btn-dark" id="cancelar-formMarca">Cancelar</button>
                                    </form>
    ...
    <script>
        var formularioMarca = document.getElementById("formularioMarca");

        formularioMarca.addEventListener("submit", function(e) {
            e.preventDefault();
            var datosDeInicioMarca = new FormData(formularioMarca);
            datosDeInicioMarca.append("accion", "marca");

            fetch("../api/apiEditor.php", {
                    method: "POST",
                    body: datosDeInicioMarca,
                })
                ...
                .then((data) => {
                    ...
                    if (data == "1") {
                       ...
                       //redirgir 
                       window.location.href = "cat-marcas.php";
        ...
        const cancelarFormularioMarca = document.getElementById("cancelar-formMarca");
        cancelarFormularioMarca.addEventListener("click", function(e) {
            e.preventDefault();
