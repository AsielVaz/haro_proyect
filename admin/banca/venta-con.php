...
<head>
    ...
    <style>
        ...
        .haro-data-table tbody tr {
            transition: background var(--haro-transition);
        }

        .haro-data-table tbody tr:hover {
            background: rgba(196,154,74,.10) !important;
        }
...
.haro-table-card::before{
    ...
    display:block;
    height:4px;
    background:linear-gradient(90deg,#b0141b,#c9a24a);
}
                                ...
                                <div class="d-flex breadcrumb-content">
                                    <div class="page-header">
                                        ...
                                        <div class="page-title haro-page-title">
                                            <span class="haro-eyebrow">Ventas concluidas</span>
                                            <h3>Panel de administración de ventas concluidas</h3>
                                        </div>
