...
.page-title h3{font-size:48px!important;}
.info-box-2{
...
@media(max-width:768px){
 ...
 .info-box-2{padding:20px!important;}
}
</style>
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="info-box-2">
                            ...
                            <div class="info-box-2-content-wrapper">
                                ...
                                <div class="info-box-2-content">Comisi¨®n venta: $<?php echo number_format($venta->comision, 2)  ?></div>
