                ...
                <div class="middle-content container-xxl p-0">
                                ...
                                <ul class="navbar-nav flex-row ms-auto breadcrumb-action-dropdown">
                                    <li class="nav-item more-dropdown">
                                        <div class="dropdown  custom-dropdown-icon">
                                            <a style="background-color: #5A9F19;" class="btn btn-succes mb-2 me-4 _effect--ripple waves-effect waves-light" href="almacen-nuevo.php">
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                            ...
                            <tr>
                            <td>' . $almacen->id . '</td>
                            <td>' . $almacen->des_gen . '</td>
                            <td>' . $almacen->direccion . '</td>
                            <td>' . $almacen->cp . '</td>
                            <td>
                                <a href="almacen-nuevo.php?id=' . $almacen->id . '" class="btn btn-primary">Editar</a>
                                <button onclick="baja(' . $almacen->id . ')" class="btn btn-danger">Eliminar</button>
