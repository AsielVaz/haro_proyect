                ...
                <div class="middle-content container-xxl p-0">
                                ...
                                <div class="d-flex breadcrumb-content">
                                    <div class="page-header">
                                        ...
                                        <div class="page-title">
                                            <h3>Panel de administración de marcas</h3>
                                        </div>
                                ...
                                <ul class="navbar-nav flex-row ms-auto breadcrumb-action-dropdown">
                                    <li class="nav-item more-dropdown">
                                        <div class="dropdown  custom-dropdown-icon">
                                            <a style="background-color: #5A9F19;" class="btn btn-succes mb-2 me-4 _effect--ripple waves-effect waves-light" href="cat-marcas-nueva.php">
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                            ...
                            <td>' . $marc->id . '</td>
                            <td>' . $marc->marca . '</td>
                            <td><img style="width: 100px" class="responsive" src="'.$marc->imagen.'" alt=""></td>
