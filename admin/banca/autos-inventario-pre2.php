                                    ...
                                    <tbody>
                                        ...
                                        foreach ($autos as $auto) {
                                            ...
                                            <tr class="columna" style=" background-image: url("'.$imagen.'");>
                                                ...
                                                <a target="_blank" href="venta-nueva-pre.php?auto=' . $auto->id . '&cliente='.$_GET['id'].'"  class="btn btn-warning btn-rounded mb-2 me-4 _effect--ripple waves-effect waves-light">Simular Compra</a>
