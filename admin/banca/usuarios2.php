                                ...
                                <ul class="navbar-nav flex-row ms-auto breadcrumb-action-dropdown">
                                    <li class="nav-item more-dropdown">
                                        <div class="dropdown  custom-dropdown-icon">
                                            <a style="background-color: #5A9F19;" class="btn btn-succes mb-2 me-4 _effect--ripple waves-effect waves-light" href="usuario-nuevo.php">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($usuarios as $usuario) {
                                            ...
                                            echo '<td><button onclick="baja('.$usuario->id.')" class="btn btn-warning btn-rounded mb-2 me-4 _effect--ripple waves-effect waves-light" style="background-color: #DA2D19; ">Eliminar</button>
                                                <a class="btn btn-warning btn-rounded mb-2 me-4 _effect--ripple waves-effect waves-light" style="background-color: #c2a60ccc; " href="usuario-nuevo.php?id=' . $usuario->id . '">Editar</a>
                                            </td>';
                                            echo "</tr>";
                                        }
