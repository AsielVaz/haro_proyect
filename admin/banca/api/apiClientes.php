...
function agregarCliente()
{
  ...
  $adminClientes->insertaCliente($nombre, $apellidos, $email, $telefono, $imagen, $comision);
...
function modificarCliente()
{
  ...
  $telefono = $_POST['telefono'];
  $adminClientes = new AdministradorClientesBanca();
  $adminClientes->modificaCliente($id, $nombre, $apellidos, $email, $telefono);
  $mensaje = array("mensaje" => "Cliente modificado", "status" => "ok");
  echo json_encode($mensaje);
}
