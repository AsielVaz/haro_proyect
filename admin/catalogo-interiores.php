...
<body>
    ...
    <div class="wrapper">
        ...
        $interiores = $adminEditor->dameInteriores();
            ...
            <section class="main--content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Formulario interiores</h3>
                    </div>
                    <div class="panel-content">
                        <form action="">
                            ...
                            <div class="form-group">
                                <label> <span class="label-text">Interior</span>
                        ...
                        <table id="recordsListView">
                            ...
                            <tbody>
                                ...
                                foreach ($interiores as $interior) {
                                    echo "<tr>";
                                    echo "<td>" . $interior->id . "</td>";
                                    echo "<td>" . $interior->interior . "</td>";
